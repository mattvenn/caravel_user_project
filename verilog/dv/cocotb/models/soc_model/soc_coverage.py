...
class Debug_Coverage():
    ...
    def debug_cov(self, operation, do_sampling=True):
        ...
        @CoverPoint(
            "top.caravel.soc.debug_if.char",
            xf=lambda operation: int(operation.char, 16),
            bins=[(0x0, 0x0F), (0x10, 0x2F), (0x30, 0x3F), (0x40, 0x4F), (0x50, 0x5F), (0x60, 0x6F), (0x70, 0x7F), (0x80, 0x8F), (0x90, 0x9F), (0xA0, 0xAF), (0xB0, 0xBF), (0xC0, 0xCF), (0xD0, 0xDF), (0xE0, 0xEF), (0xF0, 0xFF)],
            bins_labels=["0x0, 0x0F", "0x10, 0x2F", "0x30, 0x3F", "0x40, 0x4F", "0x50, 0x5F", "0x60, 0x6F", "0x70, 0x7F", "0x80, 0x8F", "0x90, 0x9F", "0xA0, 0xAF", "0xB0, 0xBF", "0xC0, 0xCF", "0xD0, 0xDF", "0xE0, 0xEF", "0xF0, 0xFF"],
            rel=lambda val, b: b[0] <= val <= b[1]
        )
        @CoverCross(
            "top.caravel.soc.uart.char_type",
